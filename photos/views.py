...
def about(request):
    ...
    return render(
        ...
        'photos/about.html',
        {
            ...
            'message':'SymCheck Plus is a self-diagnosing, symptom-checking application that allows users to upload a picture of their illness area and receive a diagnosis based on an original Machine Learning algorithm.',
            'year':datetime.now().year,
        }
    )
